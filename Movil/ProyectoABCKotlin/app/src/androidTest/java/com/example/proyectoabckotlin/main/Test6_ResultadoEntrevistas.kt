...
class Test6_ResultadoEntrevistas {
    ...
    @Test
    fun test6_ResultadoEntrevistas() {
        ...
        val appCompatButton2 = onView(
            allOf(
                withId(R.id.resultado_entrevistas_button),
                withText("See Result Interviews"),
                withContentDescription("Button to see the results of the interviews"),
                childAtPosition(
                    childAtPosition(
                        withId(android.R.id.content),
                        0
        ...
        val textView = onView(
            allOf(
                withId(R.id.ver_resultados_pruebas),
                withText("Interview Results"),
                withContentDescription("Title of interview results"),
                withParent(withParent(withId(android.R.id.content))),
                isDisplayed()
            )
        )
        textView.check(matches(withText("Interview Results")))
    }
